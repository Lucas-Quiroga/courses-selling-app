        ...
        <div className="flex justify-between items-center border-b-2 border-gray-100 py-6 md:justify-start md:space-x-10">
          ...
          <nav className="hidden md:flex space-x-10">
            ...
            {(session?.user || isAuth) && (
              <Link
                href="/cart/checkout"
                className="text-base font-medium text-gray-500 hover:text-gray-900 mt-1"
              >
                <FaCartShopping />
              </Link>
            )}
            ...
            <div className="relative">
              ...
              {isMoreOpen && (
                <div className="absolute z-10 left-1/2 transform -translate-x-1/2 mt-9 px-2 w-screen max-w-md sm:px-0">
